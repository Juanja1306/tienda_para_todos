...
export default function Login({ cliente, handleChange, handleSubmit, isValidForm, page }: LoginProps) {
                            ...
                            <div className="cont__camp">
                                ...
                                <div className="camp__inputs">
                                    ...
                                    <section className="camp__text">
                                        <h3 className="camp__title">{page === allRoutesComponents.login ? 'Ingrese su usuario' : 'Registrese'}</h3>
                                    </section>
                                    <div className="camp">
